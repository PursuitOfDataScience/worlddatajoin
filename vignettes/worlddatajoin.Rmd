---
title: "worlddatajoin: Joining World Data to Maps on the ISO Spine"
author: |
  Youzhi Yu
...
vignette: >
  %\VignetteIndexEntry{worlddatajoin: Joining World Data to Maps on the ISO Spine}
...
entities. **worlddatajoin** resolves this friction by adopting ISO 3166 codes as
...
`worlddatajoin` keeps its original soul — ISO codes as the universal join key,
