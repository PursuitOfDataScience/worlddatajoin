# worlddatajoin: Joining World Data to Maps on the ISO Spine
...
different entities. **worlddatajoin** resolves this friction by adopting
...
![](worlddatajoin_files/figure-html/unnamed-chunk-5-1.png)
...
![](worlddatajoin_files/figure-html/unnamed-chunk-6-1.png)
...
![](worlddatajoin_files/figure-html/unnamed-chunk-7-1.png)
...
![](worlddatajoin_files/figure-html/unnamed-chunk-8-1.png)
...
![](worlddatajoin_files/figure-html/unnamed-chunk-9-1.png)
...
`worlddatajoin` keeps its original soul — ISO codes as the universal
join key, one call to a map-ready table — and extends it into a complete
...
#> [1] dplyr_1.2.1         ggplot2_4.0.3       worlddatajoin_1.0.0
#> 
